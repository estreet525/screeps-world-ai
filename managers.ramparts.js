...
module.exports = {
    run(room) {
        ...
        // 🔒 Priority gating:
        // Skip ramparts while higher-priority structures are still being built.
        ...
        for (const obj of important) {
            ...
            if (result === OK) {
                console.log(
                    `[RAMPARTS] Placed rampart site over ${obj.structureType || 'controller'} in ${room.name} at (${x},${y})`
                );
